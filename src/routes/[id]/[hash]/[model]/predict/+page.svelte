	...
	<div class="w-1/2">
		<div>
			...
			<input
				...
				class="w-3/5 h-full px-2 py-3 bg-transparent text-black border border-slate-600 focus:outline-none hover:border-black"
		...
		<button
			class="text-center border border-gray-500 bg-gray-500 w-1/2 rounded-md py-3 transition-transform transform active:scale-95"
			on:click={predict}>Predict</button
		>
	</div>
	{#if resultValue}
		<div class="w-1/2 mr-60 mb-80 rounded border-4 border-gray-500">
